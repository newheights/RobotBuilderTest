...
public class OI {
    ...
    public OI() {
        ...
        button1 = new JoystickButton(driverJoystick, 1);
        button1.whenPressed(new ExtendBallKicker());
        
        button2 = new JoystickButton(driverJoystick, 2);
        button2.whileHeld(new WaveFlagAround());
        ...
        button6.toggleWhenPressed(new WaveFlagUp());
