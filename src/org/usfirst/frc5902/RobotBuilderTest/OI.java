...
public class OI {
    ...
    public JoystickButton joystickForward;
    public JoystickButton joystickBack;
    ...
    public OI() {
        ...
        joystickBack = new JoystickButton(driverJoystick, 1);
        joystickBack.whileHeld(new IntakeBall());
        joystickForward = new JoystickButton(driverJoystick, 1);
        joystickForward.whileHeld(new EjectBall());
