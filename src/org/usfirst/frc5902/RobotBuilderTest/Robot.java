...
import org.usfirst.frc5902.RobotBuilderTest.subsystems.*;
...
public class Robot extends IterativeRobot {
    ...
    public static CheeringSection cheeringSection;
    ...
    public void teleopPeriodic() {
        Scheduler.getInstance().run();
        /** 
         * Enable all this to get back ultrasonic and solenoid status from string 
        ...
        // Uncomment the two items below to Put Xbox X & Y Axis to smart dashboard
