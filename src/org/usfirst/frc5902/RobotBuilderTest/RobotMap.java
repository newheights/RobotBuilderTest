...
public class RobotMap {
    ...
    public static DigitalInput intakeintakeLimitSwitch;
    public static Servo intakeinputKicker;
    ...
    public static void init() {
        ...
        driveTrainUltrasonic = new Ultrasonic(1, 2);
        ...
        intakeintakeLimitSwitch = new DigitalInput(0);
        LiveWindow.addSensor("Intake", "intakeLimitSwitch", intakeintakeLimitSwitch);
        
        intakeinputKicker = new Servo(3);
        LiveWindow.addActuator("Intake", "inputKicker", intakeinputKicker);
        
        pneumaticSystemCompressor = new Compressor(0);
        
        
        pneumaticSystemDoubleSolenoid = new DoubleSolenoid(0, 0, 1);
        LiveWindow.addActuator("Pneumatic System", "Double Solenoid", pneumaticSystemDoubleSolenoid);
